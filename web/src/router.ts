...
import ProjectReport from "./pages/ProjectReport.vue";
...
export const router = createRouter({
  ...
  routes: [
    ...
    { path: "/projects/:name/report", component: ProjectReport, props: true },
    { path: "/unassigned", component: ProjectDashboard, props: { name: "__unassigned" } },
    { path: "/unassigned/report", component: ProjectReport, props: { name: "__unassigned" } },
